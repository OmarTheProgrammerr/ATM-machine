using System; // to use the system library in C#
...
public class cardHolder{
    ...
    public static void Main(String [] args){
        ...
        // create a database of fake users to run the code with
        List<cardHolder> cardHolders = new List<cardHolder>();

        cardHolders.Add(new cardHolder("4532761841325802", 4321, "Ashley" , "Jones", 321.13));
        cardHolders.Add(new cardHolder("5128381368581872", 9999, "Frida Frida ", "Dickerson", 105.59));
        ...
        while (true ){
            ...
            try{
                ...
                // Check against our database ( the list I made )
